...
nvn_config = open(f"{foldername}/.nvnfile/config.nvn.json", "w")
nvn_plugin = open(f"{foldername}/.nvnfile/plugins.nvn.json", "w")
nvn_cache = open(f"{foldername}/.nvnfile/cache.nvn.json", "w")
